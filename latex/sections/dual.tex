...
\begin{tikzpicture}[overlay, remember picture]
    \node[anchor=center] at ($(current page.center) + (0, -1cm)$) {
        \includegraphics[width=0.6\textwidth, height=0.5\textheight, keepaspectratio]{../assets/highlights/Highlights/SmilesNCAA SWIM AND DIVE THU CHAMPS PRELIMS (33).JPG}
    };
\end{tikzpicture}
...
\begin{tikzpicture}[overlay, remember picture]
    \node[anchor=center] at ($(current page.center) + (0, -1cm)$) {
        \includegraphics[width=0.6\textwidth, height=0.5\textheight, keepaspectratio]{../assets/highlights/Highlights/Cheam0337.JPG}
    };
\end{tikzpicture}
...
\begin{tikzpicture}[overlay, remember picture]
    \node[anchor=center] at ($(current page.center) + (0, -1cm)$) {
        \includegraphics[width=0.6\textwidth, height=0.5\textheight, keepaspectratio]{../assets/highlights/Highlights/Chang9552.JPG}
    };
\end{tikzpicture}
...
\begin{tikzpicture}[overlay, remember picture]
    \node[anchor=center] at ($(current page.center) + (0, -1cm)$) {
        \includegraphics[width=0.6\textwidth, height=0.5\textheight, keepaspectratio]{../assets/highlights/Highlights/DSC01588.JPG}
    };
\end{tikzpicture}
...
\begin{tikzpicture}[overlay, remember picture]
    \node[anchor=center] at ($(current page.center) + (0, -1cm)$) {
        \includegraphics[width=0.6\textwidth, height=0.5\textheight, keepaspectratio]{../assets/highlights/Highlights/Fitzpatrick8893.JPG}
    };
\end{tikzpicture}
