...
\begin{tikzpicture}[overlay, remember picture]
    ...
    \node[anchor=center, text width=12cm, align=center] at ($(current page.north) + (0, -3.5cm)$) {
        \fontsize{36pt}{40pt}\selectfont\textbf{\textcolor{teamprimary}{CMS at UCSD}}
    };
...
\begin{tikzpicture}[overlay, remember picture]
    \node[anchor=center] at ($(current page.center) + (0, -1cm)$) {
        \%includegraphics[width=0.6\textwidth, height=0.5\textheight, keepaspectratio]{../assets/highlights/Highlights/DSC02268.jpg}
    };
\end{tikzpicture}
...
\begin{tikzpicture}[overlay, remember picture]
    \node[anchor=center] at ($(current page.center) + (0, -1cm)$) {
        \%includegraphics[width=0.6\textwidth, height=0.5\textheight, keepaspectratio]{../assets/highlights/Highlights/Crewe8896.jpg}
    };
\end{tikzpicture}
...
\begin{tikzpicture}[overlay, remember picture]
    ...
    % Section title
    \node[anchor=center, text width=12cm, align=center] at ($(current page.north) + (0, -3.5cm)$) {
        \fontsize{36pt}{40pt}\selectfont\textbf{\textcolor{teamprimary}{CMS at Cal Baptist Distance Meet}}
    };
...
\begin{tikzpicture}[overlay, remember picture]
    \node[anchor=center] at ($(current page.center) + (0, -1cm)$) {
        \%includegraphics[width=0.6\textwidth, height=0.5\textheight, keepaspectratio]{../assets/highlights/Highlights/DSC01245.jpg}
    };
\end{tikzpicture}
...
\begin{tikzpicture}[overlay, remember picture]
    \node[anchor=center] at ($(current page.center) + (0, -1cm)$) {
        \%includegraphics[width=0.6\textwidth, height=0.5\textheight, keepaspectratio]{../assets/highlights/Highlights/Schrag0406.jpg}
    };
\end{tikzpicture}
...
\begin{tikzpicture}[overlay, remember picture]
    ...
    % Section title
    \node[anchor=center, text width=12cm, align=center] at ($(current page.north) + (0, -3.5cm)$) {
        \fontsize{36pt}{40pt}\selectfont\textbf{\textcolor{teamprimary}{CMS at PP}}
    };
...
\begin{tikzpicture}[overlay, remember picture]
    \node[anchor=center] at ($(current page.center) + (0, -1cm)$) {
        \%includegraphics[width=0.6\textwidth, height=0.5\textheight, keepaspectratio]{../assets/highlights/Highlights/DSC07873.jpg}
    };
\end{tikzpicture}
...
\begin{tikzpicture}[overlay, remember picture]
    \node[anchor=center] at ($(current page.center) + (0, -1cm)$) {
        \%includegraphics[width=0.6\textwidth, height=0.5\textheight, keepaspectratio]{../assets/highlights/Highlights/DSC06427.jpg}
    };
\end{tikzpicture}
