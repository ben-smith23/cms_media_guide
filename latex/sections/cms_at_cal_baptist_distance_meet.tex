% ===== CMS vs Cal Baptist Distance Meet =====
% Generated automatically from ordered_times.csv

\clearpage
\sectionImageOverlay{../assets/highlights/Highlights/ManfrediNCAA SWIM AND DIVE FRI PRELIMS_5.jpg}{CMS vs Cal Baptist Distance Meet}
