% =============================================================================
% SECTION TITLE PAGE DESIGN OPTIONS FOR "MEET INFORMATION"
% =============================================================================
% Try each option below - comment out the two you don't want to use

% ----------------------------------------------------------------------------
% OPTION A: Full-Page Image with Overlay Banner
% ----------------------------------------------------------------------------
% DRAMATIC & BOLD - Action photo fills entire page with title in maroon banner
% Best for: High-energy sections, showcasing exciting action shots
%
...
% ----------------------------------------------------------------------------
% MODERN & DYNAMIC - Angular diagonal cut between maroon and photo
% Best for: Contemporary look, adds motion and energy
%
...
% ----------------------------------------------------------------------------
% CLEAN & PROFESSIONAL - Vertical split with title on left, photo on right
% Best for: Elegant and balanced look, easy to read
%
