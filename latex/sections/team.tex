...
\begin{tikzpicture}[overlay, remember picture]
    \node[anchor=center] at ($(current page.center) + (0, -1cm)$) {
        \includegraphics[width=0.6\textwidth, height=0.5\textheight, keepaspectratio]{../assets/highlights/Highlights/DeedyNCAA SWIM AND DIVE CHAMPS WED PRELIMS_29 (17).jpg}
    };
\end{tikzpicture}
